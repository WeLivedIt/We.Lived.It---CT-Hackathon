...
const mockFetchSubmissions = async () => {
  ...
  return [
    {
      id: "1",
      text: "This is an example of hate speech...",
      category: "Racial",
      votes: { up: 15, down: 3 },
    },
    {
      id: "2",
      text: "Another instance of offensive language...",
      category: "Gender-based",
      votes: { up: 10, down: 5 },
    },
    {
      id: "3",
      text: "A submission that might be considered hate speech...",
      category: "Religious",
      votes: { up: 8, down: 7 },
    },
  ];
...
export const CommunityVoting: FC<CommunityVotingProps> = ({
  isOpen,
  onClose,
}) => {
            ...
            <div className="max-w-2xl mx-auto bg-white shadow-md rounded-lg">
              <div className="p-4">
                ...
                <p className="text-gray-600 text-sm">
                  Vote on submissions to help fine-tune our AI model and improve
